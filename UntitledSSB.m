...
figure; plot(t1, demodulated); title('Received Signal (CD) in Time domain');
...
figure; plot(f, abs(F) / L); title('Spectrum of Received Signal (CD)');
...
% plot demodulated signal in time domain
figure; plot(t1, demodulated); title('Received Signal (Coherent Detection with Butterworth) - Time Domain');
...
% plot demodulated signal in frequency domain
figure; plot(f, abs(F) / L); title('Spectrum of SSB-LSB Signal (Butterworth Filter)');
